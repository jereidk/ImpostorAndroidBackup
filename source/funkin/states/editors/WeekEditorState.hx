...
class WeekEditorState extends MusicBeatState
{
	...
	function reloadBG()
	{
		...
		{
			if (FunkinAssets.exists(Paths.getPath('images/menubackgrounds/menu_$assetName.png', null, NORMAL)))
			{
	...
	function reloadWeekThing()
	{
		...
		if (assetName != null && assetName.length > 0)
		{
			if (FunkinAssets.exists(Paths.getPath('images/storymenu/$assetName.png', null, NORMAL)))
			{
