...
class MarathonMenuState extends AmongUIState
{
	...
	override function create()
	{
		...
		detective.frames = FlxAnimateFrames.fromAnimate(Paths.getPath('images/${ext}detective/base', null, NORMAL));
		...
		detectiveHands.frames = FlxAnimateFrames.fromAnimate(Paths.getPath('images/${ext}detective/hands', null, NORMAL));
		...
		peekers.frames = FlxAnimateFrames.fromAnimate(Paths.getPath('images/${ext}/peekers', null, NORMAL));
